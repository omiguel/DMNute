...
RtcRoot.prototype.wiring = function(){
    ...
    me.listeners['modelodisp.updated'] = me.emitePraInterface.bind(me);
    ...
    me.listeners['mapaup.updated'] = me.emitePraInterface.bind(me);
    me.listeners['mapadel.destroied'] = me.emitePraInterface.bind(me);
...
RtcRoot.prototype.interfaceWiring = function(){
    ...
    me.browserlisteners['modelodisp.update'] = me.daInterface.bind(me);
